...
local questTable = {
	...
	{storage = Storage.SeaOfLight.Mission3, storageValue = 4},
	{storage = Storage.TheSecretLibrary.PinkTel, storageValue = 2},
	{storage = Storage.TheSecretLibrary.HighDry, storageValue = 6},
	{storage = Storage.TheSecretLibrary.Peacock, storageValue = 2},
	{storage = Storage.TheSecretLibrary.Mota, storageValue = 12},
	{storage = Storage.TheSecretLibrary.LiquidDeath, storageValue = 12},
	...
	{storage = Storage.Kilmaresh.Questline, storageValue = 1},
	{storage = Storage.Kilmaresh.Eighth.Narsai, storageValue = 3},
	{storage = Storage.Kilmaresh.Eighth.Shimun, storageValue = 3},
	{storage = Storage.Kilmaresh.Eighth.Tefrit, storageValue = 3},
	{storage = Storage.Kilmaresh.Eighth.Yonan, storageValue = 3},
	{storage = Storage.Kilmaresh.Eleven.Basin, storageValue = 2},
	{storage = Storage.Kilmaresh.Fifth.MemoriesShards, storageValue = 0},
	{storage = Storage.Kilmaresh.Fifth.Memories, storageValue = 6},
	{storage = Storage.Kilmaresh.First.Mission, storageValue = 5},
	{storage = Storage.Kilmaresh.First.Title, storageValue = 1},
	{storage = Storage.Kilmaresh.Fourteen.Remains, storageValue = 2},
	{storage = Storage.Kilmaresh.Fourth.Moe, storageValue = 5},
	{storage = Storage.Kilmaresh.Nine.Owl, storageValue = 1},
	{storage = Storage.Kilmaresh.Second.Investigating, storageValue = 6},
	{storage = Storage.Kilmaresh.Set.Narsai, storageValue = 1},
	{storage = Storage.Kilmaresh.Set.Ritual, storageValue = 1},
	{storage = Storage.Kilmaresh.Set.Shimun, storageValue = 1},
	{storage = Storage.Kilmaresh.Set.Tefrit, storageValue = 1},
	{storage = Storage.Kilmaresh.Set.Yonan, storageValue = 1},
	{storage = Storage.Kilmaresh.Sixth.BlessedStatues, storageValue = 0},
	{storage = Storage.Kilmaresh.Sixth.Favor, storageValue = 12},
	{storage = Storage.Kilmaresh.Sixth.FourMasks, storageValue = 0},
	{storage = Storage.Kilmaresh.Third.Recovering, storageValue = 3},
	{storage = Storage.Kilmaresh.Thirteen.Fafnar, storageValue = 301},
	{storage = Storage.Kilmaresh.Thirteen.Lyre, storageValue = 4},
	{storage = Storage.Kilmaresh.Thirteen.Presente, storageValue = 3},
